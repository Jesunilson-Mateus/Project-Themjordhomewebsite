...
(function () {
  ...
  var UI = {
    ...
    'booking.babyKit.quantity': { pt: 'Quantos kits', en: 'How many kits', fr: 'Combien de kits' },
    ...
    'booking.transfer.people': { pt: 'Quantas pessoas', en: 'How many people', fr: 'Combien de personnes' },
    ...
    'booking.step1': { pt: 'Datas de estadia', en: 'Dates', fr: 'Dates' },
    'booking.step2': { pt: 'Quantas pessoas?', en: 'How many guests?', fr: 'Combien de personnes ?' },
    'booking.step3': { pt: 'Serviços adicionais', en: 'Extra services', fr: 'Services supplémentaires' },
    'booking.step4': { pt: 'Contacto', en: 'Contact', fr: 'Contact' },
    'booking.step5': { pt: 'Resumo e confirmação', en: 'Review & confirm', fr: 'Résumé et confirmation' },
    'booking.notes': { pt: 'Notas ou pedidos especiais (opcional)', en: 'Notes or special requests (optional)', fr: 'Notes ou demandes spéciales (optionnel)' },
    'booking.requiredFields': { pt: 'Por favor, preencha os campos obrigatórios', en: 'Please fill in all required fields', fr: 'Veuillez remplir tous les champs obligatoires' },
    'booking.people': { pt: 'pessoas', en: 'people', fr: 'personnes' },
    'booking.dateRange': { pt: 'Selecione as datas', en: 'Select dates', fr: 'Sélectionnez les dates' },
    'booking.dateSeparator': { pt: '—', en: '—', fr: '—' },
    'booking.calendarNote': { pt: 'Clique para ver disponibilidade', en: 'Click to see availability', fr: 'Cliquez para voir la disponibilité' },
    'booking.capacityNote': { pt: 'Máximo 2 adultos. Bebés não contam para o limite.', en: 'Maximum 2 adults. Babies do not count towards the limit.', fr: 'Maximum 2 adultes. Les bébés ne comptent pas dans la limite.' },
    'booking.email': { pt: 'Email', en: 'Email', fr: 'Email' },
    'booking.back': { pt: '← Voltar', en: '← Back', fr: '← Retour' },
